...
class Menubar:
    ...
    def show_about_message(self):
        box_title = "About Dip"
        box_message = "Dip's Editor"
        messagebox.showinfo(box_title, box_message)

    def show_release_notes(self):
        box_title = "Release Notes"
        box_message = "Dip - Version R"
        messagebox.showinfo(box_title, box_message)
...
class DreamText:
    ...
    def __init__(self, master=None):
        if master:
            master.title("Untitled - Dip Editor")
    ...
    def set_window_title(self, name=None):
        if name:
            self.master.title(name + " - Dip Editor")
        else:
            self.master.title("Untitled - Dip Editor")
