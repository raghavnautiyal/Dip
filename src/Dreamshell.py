...
class TextConsole(tk.Text):
    def __init__(self, master, **kw):
        ...
        banner = kw.pop('banner', "Dreamscript Beta (Version 0.1)\nType in 'exit' to exit the shell\n\n")
...
class Menubar:
    ...
    def show_about_message(self):
        box_title = "About Dreamscript"
        box_message = "The Dreamscript IDE!"
        messagebox.showinfo(box_title, box_message)

    def show_release_notes(self):
        box_title = "Release Notes"
        box_message = "Dreamshell - Beta"
        messagebox.showinfo(box_title, box_message)
...
class DreamText: 
    ...
    def set_window_title(self, name=None):
        if name:
            self.master.title(name + " - Dreamshell")
        else:
            self.master.title("Untitled - Dreamshell")
